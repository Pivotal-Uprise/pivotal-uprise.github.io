        ...
        <div className='flex flex-col justify-center grow'>
          <div className='grid grid-cols-auto gap-8 place-items-center w-full sm:px-6 lg:px-8 lg:grid-cols-3'>
            <Card
              title='Faceboook ads'
              description='
                We provide Facebook advertising services for your business. We can create ads for your business and manage them for you.'
              className='devcard'
            />
            <Card
              title='Instagram ads'
              description='
                We provide Instagram advertising services for your business. We can create ads for your business and manage them for you.'
              className='hostcard'
            />
            <Card
              title='TikTok Ads'
              description='
                            We provide TikTok advertising services for your business. We can create ads for your business and manage them for you.'
              className='hostcard'
            />
            <Card
              title='Email Marketing'
              description='
                            We provide email marketing services for your business, with complex strategies to increase your sales.'
              className='hostcard'
            />
            <Card
              title='Social Media Marketing'
              description='
                            We provide all sorts of social media marketing services for your business, with complex strategies to increase your sales.'
              className='hostcard'
            />
            <Card
              title='Freelancing'
              description='Directory submission, online reputation management and optimization services for your region.'
              className='hostcard'
            />
          </div>
        </div>
